...
public class clientUpdateLicenceInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_update_licence_info);
    ...
    private void Fileuploader() {
        ...
        a=String.valueOf(ruf.userid)+"_license";//System.currentTimeMillis();
...
//        StorageReference imageRef = storageReference.child("Images/my.png");
        StorageReference imageRef = storageReference.child("Images/"+String.valueOf(ruf.userid)+"_license"+".jpg");
